...
all_stock = initial_bill_stock + initial_coin_stock
...
def main():
    ...
    while running:
        ...
        draw_text("Estoque de Cédulas e Moedas", (80, 120), font_obj=large_font)
        for i, label in enumerate(all_labels):
            y = 180 + i * 45
            draw_coin_icon(100, y + 18, all_colors[i])
